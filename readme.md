...
<p>Una vez ejecutado saldra Laravel development server started:<strong> http://127.0.0.1:8000 </strong>La ip es la que se debera poner en el navegador y ya tendremos acceso a la aplicación</p>
